...
// 💡 修正：防呆機制改為認「登入身分 (currentUserRole)」，解決跨裝置或換手機無法編輯的問題
export const RecordItem = ({ exp, idx, currentUserRole, isSortable = false, hideActions = false, onRecordClick, handleMoveRecord, openEditForm, setCrossRoomRecord }) => {
  ...
  // 💡 以身分 (老婆 / 老公) 作為解鎖條件，即使換手機、清空紀錄，只要登入身分對了就能改
  const canModify = !exp.addedByRole || exp.addedByRole === currentUserRole; 
